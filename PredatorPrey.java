...
public class PredatorPrey {
    ...
    public static void runSimulation(int n, int s, int t) {
        ...
        while (!checkIfChaught(prey, predator) && t > 0) { // Active while pray has not been caught and the maximum
                                                           // number of iterations is not met.
            // Move prey
            prey.translate(random.nextInt(2 * s + 1) - s, random.nextInt(2 * s + 1) - s); // Random range [-2;2] by
                                                                                          // offset
    ...
    public static void displayMap(Point prey, Point predator, int n) {
        ...
        // Insert '/t' in every element. Fill only works in 1D, hence why running though
        // the array
        ...
        // Turn the 2D array into a single string. Afterwards return it properly
        // line-by-line
